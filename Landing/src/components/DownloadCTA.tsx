...
const APK_URL = process.env.NEXT_PUBLIC_APK_URL || 'https://media.pitgo.uz/pitgo-2.2.0.apk'
const APK_PRO_URL = process.env.NEXT_PUBLIC_APK_PRO_URL || 'https://media.pitgo.uz/pitgo-pro-2.2.0.apk'
