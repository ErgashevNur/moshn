    ...
    <footer className="border-t border-white/[.08] py-10 px-5 sm:px-8">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
        <div className="flex items-center gap-2.5">
          <Image src="/brand/shina24-mark-white.png" alt="PitGo" width={22} height={22} />
          <span className="text-[14px] font-bold">PitGo</span>
        </div>
        <p className="text-[12.5px] text-txt3 text-center order-last sm:order-none">
          © {new Date().getFullYear()} PitGo. {t.footer.rights}
        </p>
