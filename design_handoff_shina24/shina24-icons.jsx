// shina24-icons.jsx — clean 24px line icons, currentColor
function Icon({ name, size = 22, stroke = 1.8, fill = false, style }) {
  ...
  const paths = {
    ...
    users: <><circle cx="9" cy="8" r="3.5"/><path d="M3 20c0-3 2.7-5 6-5s6 2 6 5"/><circle cx="17" cy="8" r="2.5" opacity=".5"/><path d="M21 20c0-2.5-1.8-4-4-4" opacity=".5"/></>,
    ...
    cashIn: <><rect x="3" y="6" width="18" height="13" rx="3"/><path d="M3 10h18"/><circle cx="12" cy="14.5" r="2.5"/><path d="M7 14.5h2M15 14.5h2"/></>,
    barChart: <><path d="M4 18V10M8 18V6M12 18V12M16 18V8M20 18V4"/></>,
    edit: <><path d="M15 4l5 5-10.5 10.5L4 21l1.5-5.5z"/><path d="M14 5l5 5"/></>,
    notePad: <><rect x="5" y="3" width="14" height="18" rx="2"/><path d="M9 7h6M9 11h6M9 15h4"/></>,
    scan: <><path d="M3 9V5a2 2 0 012-2h4M15 3h4a2 2 0 012 2v4M3 15v4a2 2 0 002 2h4M15 21h4a2 2 0 002-2v-4M7 12h10"/></>,
    timerPlay: <><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2.5 2"/><path d="M9.5 3.5l2.5-2 2.5 2"/></>,
  };
